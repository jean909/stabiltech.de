...
import { Code, GitBranch, ArrowRight, MessageSquare, CheckCircle } from 'lucide-react';
...
export function OpenSourcePage() {
  ...
  const contributions = [
    { icon: Code, title: t('repos'), desc: t('reposDesc') },
    { icon: GitBranch, title: t('prs'), desc: t('prsDesc') },
    { icon: MessageSquare, title: t('ideas'), desc: t('ideasDesc') },
  ];

  const ways = [t('col1'), t('col2'), t('col3'), t('col4'), t('col5'), t('col6')];
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
            <p className="text-neutral-500 uppercase tracking-[0.3em] text-xs font-medium mb-4">{t('howTagline')}</p>
            <h2 className="text-3xl font-bold text-black">{t('howTitle')}</h2>
          </motion.div>
      ...
      <section className="py-20 bg-neutral-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <p className="text-neutral-500 uppercase tracking-[0.3em] text-xs font-medium mb-4">{t('collabTagline')}</p>
            <h2 className="text-3xl font-bold text-black">{t('collabTitle')}</h2>
          </motion.div>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <SiGithub className="w-12 h-12 text-neutral-400 mx-auto mb-6" />
